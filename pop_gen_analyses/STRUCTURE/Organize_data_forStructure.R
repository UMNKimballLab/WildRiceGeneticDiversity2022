...
csamp<-read.csv("Sample_Key_with_cultivated_231003.csv", header=TRUE)
...
#Parameters were set to 1000 burn in and 10,000 iterations using admixture model, allele frequencies correlated
