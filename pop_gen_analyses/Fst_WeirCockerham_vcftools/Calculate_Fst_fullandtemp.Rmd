...
```{r}
setwd("G:/My Drive/Kimball lab/Projects/Genetic Diversity/Fst")
library(StAMPP)
library(tidyverse)
library(ggplot2)

#Load genlight objects created previously
load("G:/My Drive/Kimball lab/Projects/Genetic Diversity/Fst/Fstgenlight.Rdata")
load("G:/My Drive/Kimball lab/Projects/Genetic Diversity/UPGMA tree/genlight_temp.Rdata")
tempsamp<-read.csv("G:/My Drive/Kimball lab/Projects/Genetic Diversity/SampleKey_OnlyTemporal_240205.csv")
```
...
save(allfst,tempfst, file="G:/My Drive/Kimball lab/Projects/Genetic Diversity/Fst/fstscores.Rdata")
```
```{r}
#I exported the all fst values and organized them manually into a table for easier plotting, loading that in here
fstdat<-read.csv("G:/My Drive/Kimball lab/Projects/Genetic Diversity/Fst/allfst_table.csv")
